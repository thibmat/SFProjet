 ...
 */
final class Version20190708120831 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE annonces (id INT AUTO_INCREMENT NOT NULL, category_id INT NOT NULL, annonce_titre VARCHAR(255) NOT NULL, annonce_texte LONGTEXT NOT NULL, is_published TINYINT(1) DEFAULT NULL, annonce_prix DOUBLE PRECISION NOT NULL, INDEX IDX_CB988C6F12469DE2 (category_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE categories (id INT AUTO_INCREMENT NOT NULL, category_id INT DEFAULT NULL, category_libelle VARCHAR(128) NOT NULL, INDEX IDX_3AF3466812469DE2 (category_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE app_user (id INT AUTO_INCREMENT NOT NULL, user_name VARCHAR(180) NOT NULL, roles JSON NOT NULL, password VARCHAR(255) NOT NULL, created_at DATETIME NOT NULL, user_adress VARCHAR(255) DEFAULT NULL, user_code_postal INT DEFAULT NULL, user_ville VARCHAR(128) DEFAULT NULL, user_tel VARCHAR(20) DEFAULT NULL, UNIQUE INDEX UNIQ_88BDF3E924A232CF (user_name), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
