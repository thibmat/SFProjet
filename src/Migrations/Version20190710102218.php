 ...
 */
final class Version20190710102218 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE annonces (id INT AUTO_INCREMENT NOT NULL, category_id INT NOT NULL, author_id INT NOT NULL, annonce_titre VARCHAR(255) NOT NULL, annonce_texte LONGTEXT NOT NULL, is_published TINYINT(1) DEFAULT NULL, annonce_prix NUMERIC(9, 2) NOT NULL, created_at DATETIME NOT NULL, nb_views INT DEFAULT NULL, INDEX IDX_CB988C6F12469DE2 (category_id), INDEX IDX_CB988C6FF675F31B (author_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE image (id INT AUTO_INCREMENT NOT NULL, annonces_id INT DEFAULT NULL, image_name VARCHAR(255) NOT NULL, uploaded_at DATETIME NOT NULL, INDEX IDX_C53D045F4C2885D7 (annonces_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
